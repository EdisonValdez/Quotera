...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'quotera.user_info_type' => 'getQuotera_UserInfoTypeService',
    ...
    {
        $this->services['assetic.filter.uglifyjs2'] = $instance = new \Assetic\Filter\UglifyJs2Filter('/usr/local/bin/uglifyjs', 'c:\\Program Files\\nodejs\\\\node.EXE');
    ...
    {
        return $this->services['captcha.type'] = new \Gregwar\CaptchaBundle\Type\CaptchaType($this->get('session'), $this->get('gregwar_captcha.generator'), $this->get('translator'), array('width' => 243, 'height' => 100, 'length' => 5, 'background_color' => array(0 => 255, 1 => 255, 2 => 255), 'distortion' => false, 'font' => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle\\DependencyInjection/../Generator/Font/captcha.ttf'), 'keep_value' => false, 'charset' => 'abcdefhjkmnprstuvwxyz23456789', 'as_file' => false, 'as_url' => false, 'reload' => false, 'image_folder' => 'captcha', 'web_path' => ($this->targetDirs[2].'/../web'), 'gc_freq' => 100, 'expiration' => 60, 'quality' => 30, 'invalid_message' => 'Bad code value', 'bypass_code' => NULL, 'whitelist_key' => 'captcha_whitelist_key', 'humanity' => 0, 'max_front_lines' => NULL, 'max_behind_lines' => NULL, 'interpolation' => true, 'text_color' => array(), 'disabled' => false));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'fosuser', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Quotera\\EmailBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Quotera\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Quotera\\EmailBundle\\Entity');
        $c->addDriver($b, 'Quotera\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('EmailBundle' => 'Quotera\\EmailBundle\\Entity', 'UserBundle' => 'Quotera\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_05e6516567e1102fe36b5060a96cf9c7b9e10621b19960badbe392737b01d88a');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Quotera\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Quotera\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Quotera\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Quotera\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Quotera\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'quotera.user_info_type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Quotera\UserBundle\Controller\userInfoType A Quotera\UserBundle\Controller\userInfoType instance.
     */
    protected function getQuotera_UserInfoTypeService()
    {
        return $this->services['quotera.user_info_type'] = new \Quotera\UserBundle\Controller\userInfoType($this->get('security.context'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt|error)|css|images|js)/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('evaldez@bullatickets.com');
        $a->setPassword('Thesecret1');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('mail.bullatickets.com');
        $instance->setPort(25);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'GregwarCaptchaBundle::captcha.html.twig', 1 => 'form_div_layout.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Quotera\\EmailBundle/Resources/views'), 'Email');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/views'), 'GregwarCaptcha');
        $instance->addPath(($this->targetDirs[3].'\\src\\Quotera\\UserBundle/Resources/views'), 'User');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b288afdca387ab5c6899734be4850fd79fd57e1a');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EmailBundle' => 'Quotera\\EmailBundle\\EmailBundle',
                'GregwarCaptchaBundle' => 'Gregwar\\CaptchaBundle\\GregwarCaptchaBundle',
                'UserBundle' => 'Quotera\\UserBundle\\UserBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'fosuser',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'mail.bullatickets.com',
            'mailer_user' => 'evaldez@bullatickets.com',
            'mailer_password' => 'Thesecret1',
            'secret' => 'b288afdca387ab5c6899734be4850fd79fd57e1a',
            'locale' => 'en',
            ...
            'kernel.secret' => 'b288afdca387ab5c6899734be4850fd79fd57e1a',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mail.bullatickets.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'evaldez@bullatickets.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Thesecret1',
            ...
            'assetic.filter.uglifyjs2.node' => 'c:\\Program Files\\nodejs\\\\node.EXE',
            ...
            'fos_user.model.user.class' => 'Quotera\\UserBundle\\Entity\\User',
